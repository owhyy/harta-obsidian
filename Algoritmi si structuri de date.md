...
Printre cei mai cunoscuți algoritmi se numără: [[**sortare**]] ,[[căutarea]] , [[parcurgerea arborilor]], [[backtracking]]-ul, algoritmi de **drum minim** (Dijkstra, Bellman-Ford) și algoritmi **greedy** sau **dinamicii programate** (ex: Knapsack, LCS).
